...
\item \textbf{Fichier de configuration}\;~ La sonde \PHP utilise un fichier de configuration en plus des variables d'environnement. Il pourrait être utile de faire la même chose avec la probe \Python. Par contre il faut déterminer où positionner ce fichier car, contrairement à \PHP, \Python n'en utilise aucun.
